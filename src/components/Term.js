...
export default function Term() {
  ...
  const [prompt, setPrompt] = React.useState("user@/RTerm:~$ ");
  const [home, sethome] = React.useState("RTerm");
  ...
  return (
    <Terminal
      ref={terminal}
      welcomeMessage={[
        "Welcome to Rhine's Terminal Portfolio!",
        "---",
