...
This project is to showcase my terminal style portfolio. This is made with react js and all the commands are available. Just type the help command.
...
1. Clone repo
   ```sh
   git clone https://github.com/Coding-Err0r/RTerm.git
   ```
...
Project Link: [Porject Link](https://github.com/Coding-Err0r/RTerm.git)
